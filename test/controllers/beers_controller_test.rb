...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference("Beer.count") do
      post beers_url, params: { beer: { Beer: @beer.Beer, description: @beer.description, name: @beer.name, price: @beer.price } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { Beer: @beer.Beer, description: @beer.description, name: @beer.name, price: @beer.price } }
